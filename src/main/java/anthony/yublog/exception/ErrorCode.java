...
public enum ErrorCode {
    ...
    INVALID_TOKEN(1005, "无效的登录凭证"),
    USER_DISABLED(1006, "用户已被禁用"),
    VERIFICATION_CODE_INVALID(1007, "验证码无效"),
    USER_REGISTRATION_FAILED(1008, "用户注册失败"),
    PASSWORD_RESET_FAILED(1009, "密码重置失败"),
    PROFILE_UPDATE_FAILED(1010, "个人信息更新失败"),
